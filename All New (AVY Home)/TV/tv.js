    ...
    $(".msg").on("click", ".result", function () {
        ...
        $.ajax({
            ...
            success: function (result, status, xhr) {
                ...
                $('.modov').html("<span><strong>Storyline: </strong>" + overview + "</span><p></p><div><strong>Popularity: </strong>" + result["popularity"] + "</div><p></p><div><strong>Air Date: </strong>" + result["first_air_date"] + "</div><p></p><div><strong>Rating: </strong>" + result["vote_average"]+"</div>");
